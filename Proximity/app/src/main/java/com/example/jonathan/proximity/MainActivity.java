package com.example.jonathan.proximity;
...
public abstract class MainActivity extends AppCompatActivity {
    ...
    String lat1 = lat.getEditableText().toString();
    float la = Float.parseFloat(lat1);
    EditText longi = (EditText)findViewById(R.id.longi);
    String longi1 = lat.getEditableText().toString();
    float lo = Float.parseFloat(longi1);
    println(la);
    ...
    double az = calculateDistanceInKilometer(latitude,longitude,la,lo);*/
    float ans_lat = Math.abs(la-latitude);
    float ans_longi = Math.abs(lo-longitude);

    private void simple_Notification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.logo)
                .setContentTitle("Transafe")
                .setContentText("You have less than 10 kilometers left for your destination, please get ready.")
